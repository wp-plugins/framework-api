jQuery(document).ready(function() {
	...
	jQuery('select.chzn-select').each(function () {
		jQuery(this).next().attr('title',jQuery(this).attr('title'));
	});
	
	jQuery('.chzn-container[title]').tipTip({defaultPosition:"top",delay:50});
	jQuery('input.picker[title]').tipTip({defaultPosition:"top",delay:50});
	jQuery('input.attachment[title]').tipTip({defaultPosition:"top",delay:50});
	jQuery('input.suggest[title]').tipTip({defaultPosition:"top",delay:50});
